              ...
              <div className="mb-4 grid gap-4">
                <div className="flex items-center">
                  ...
                  <div className="w-1/2 pl-4">
                    ...
                    >
                      <i className="bx bxs-id-card"></i> <b>Id:</b>
                    </label>
                    <input
                      id="id"
                      name="id"
                    ...
                    <label
                      ...
                      className="block text-sm font-medium text-gray-900 dark:text-white"
                    >
                      <i className="bx bxs-food-menu"></i> <b>Nombre:</b>
                    </label>
                    <input
                      id="name"
                      name="name"
                    ...
                    <label
                      ...
                      className="block text-sm font-medium text-gray-900 dark:text-white"
                    >
                      <i className="bx bx-dollar-circle"></i> <b>Precio:</b>
                    </label>
                    <input
                      id="price"
                      name="price"
                    ...
                    <label
                      ...
                      className="block text-sm font-medium text-gray-900 dark:text-white"
                    >
                      <i className="bx bxs-badge-percent"></i> <b>Descuento:</b>
                    </label>
                    <input
                      id="discount"
                      name="discount"
                ...
                <button
                  className="block rounded-lg bg-orange-500 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-orange-600 focus:outline-none focus:ring-4 focus:ring-orange-300"
                  type="submit"
                >
                  Guardar Cambios
                </button>
