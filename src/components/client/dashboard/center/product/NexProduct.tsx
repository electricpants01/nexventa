  ...
  return (
    <div className="relative mx-auto w-full cursor-pointer rounded-md border duration-200 hover:shadow-xl sm:max-w-[200px]">
      <div className="relative overflow-hidden">
        <img src={img} alt={name} className="blog-banner w-full rounded-md shadow-md hover:shadow-lg" />
        <span className="absolute right-0 top-0 rounded-bl-md bg-orange-600 px-2 py-1 text-xs text-white md:text-sm">
          <p>{discount} %</p>
        </span>
      </div>
      <div className="px-1">
        <h5 className="border-b-1 text-center text-1xl font-semibold text-orange-600 ">{name}</h5>
...
<p className="text-center text-sm text-gray-800 font-semibold">{short_description}</p>
