...
export default function NexProduct({product, addCart}: NexProductProps) {
  ...
  return (
      <div className="relative mx-auto min-h-80 max-w-[200px] cursor-pointer rounded-md border duration-200 hover:shadow-xl dark:border-0">
        <span
          className="absolute right-0 top-0 rounded-bl-md bg-orange-600 px-2 py-1 text-xs text-white md:text-sm">
            <p>{discount} %</p>
        </span>
        ...
        <div className="px-2">
          ...
          <p className="text-center">
                <span
                  className="border-b-1 border-orange-600 text-xl font-semibold text-orange-600 hover:border-black hover:text-black">
                  Precio: {price} Bs
                </span>
          </p>
